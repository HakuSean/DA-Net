...
parser.add_argument('dataset', type=str, choices=['ucf101', 'hmdb51', 'ixmas', 'ixmas_view', 'ixmas_branch', 'act42', 'nucla_view', 'ntu_view', 'ntu'])
...
f_info = parse_directory(args.frame_path,
                         args.rgb_prefix, args.flow_x_prefix, args.flow_y_prefix) # XX video parsed
...
def build_net():
    ...
    if gpu_list is None:
        net = CaffeNet(args.net_proto, args.net_weights, my_id-1) # a lot of output
    else:
