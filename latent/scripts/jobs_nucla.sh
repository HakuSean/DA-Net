...
# bash scripts/train.sh nucla rgb ${OPT} 1
# bash scripts/train.sh nucla rgb ${OPT} 2
# bash scripts/train.sh nucla rgb ${OPT} 3
# bash scripts/train.sh nucla rgb ${OPT} 4
# bash scripts/train.sh nucla rgb ${OPT} 5
# bash scripts/train.sh nucla rgb ${OPT} 6
# bash scripts/train.sh nucla rgb ${OPT} 7
# bash scripts/train.sh nucla rgb ${OPT} 8
# bash scripts/train.sh nucla rgb ${OPT} 9
# bash scripts/train.sh nucla rgb ${OPT} 10

bash scripts/train.sh nucla flow ${OPT} 1
bash scripts/train.sh nucla flow ${OPT} 2
bash scripts/train.sh nucla flow ${OPT} 3
bash scripts/train.sh nucla flow ${OPT} 4
bash scripts/train.sh nucla flow ${OPT} 5
bash scripts/train.sh nucla flow ${OPT} 6
bash scripts/train.sh nucla flow ${OPT} 7
bash scripts/train.sh nucla flow ${OPT} 8
bash scripts/train.sh nucla flow ${OPT} 9
bash scripts/train.sh nucla flow ${OPT} 10
