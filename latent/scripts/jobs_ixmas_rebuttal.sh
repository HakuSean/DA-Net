...
if [[ ${GPU} == 0 ]]; then
    bash scripts/train.sh ixmas_view rgb ${OPT} 1
    bash scripts/train.sh ixmas_view rgb ${OPT} 2
    bash scripts/train.sh ixmas_view rgb ${OPT} 3
    bash scripts/train.sh ixmas_view rgb ${OPT} 4
    bash scripts/train.sh ixmas_view flow ${OPT} 1
    bash scripts/train.sh ixmas_view flow ${OPT} 2
    bash scripts/train.sh ixmas_view flow ${OPT} 3
    bash scripts/train.sh ixmas_view flow ${OPT} 4
    ...
    bash scripts/train.sh ixmas_view flow ${OPT} 5
    bash scripts/train.sh ixmas_view flow ${OPT} 6
    bash scripts/train.sh ixmas_view flow ${OPT} 7
    bash scripts/train.sh ixmas_view flow ${OPT} 8
    bash scripts/train.sh ixmas_view rgb ${OPT} 5
    bash scripts/train.sh ixmas_view rgb ${OPT} 6
    bash scripts/train.sh ixmas_view rgb ${OPT} 7
    bash scripts/train.sh ixmas_view rgb ${OPT} 8
    ...
    bash scripts/train.sh ixmas_view rgb ${OPT} 9
    bash scripts/train.sh ixmas_view rgb ${OPT} 10
    bash scripts/train.sh ixmas_view rgb ${OPT} 11
    bash scripts/train.sh ixmas_view flow ${OPT} 9
    bash scripts/train.sh ixmas_view flow ${OPT} 10
    bash scripts/train.sh ixmas_view flow ${OPT} 11
