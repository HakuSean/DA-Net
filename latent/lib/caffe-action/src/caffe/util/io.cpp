...
bool ReadSegDataToDatum(const string& img_filename, const string& label_filename, Datum* datum_data, Datum* datum_label, bool is_color) { // this function is useless
...
bool ReadSegmentRGBToDatum(const string& filename, const int label, const int view, 
...
bool ReadSegmentFlowToDatum(const string& filename, const int label, int view, 
